                                        ...
                                        return (
                                            <Link
                                                ...
                                                className={classNames(
                                                    isCurrent
                                                        ? `rounded-xl border px-3 py-2 text-sm font-medium ${theme === "dark" ? "bg-slate-50 text-blue-700" : "bg-blue-700 text-slate-50"}`
                                                        : `${theme === "dark" ? "text-white" : "text-slate-500"} hover:text-blue-600,
